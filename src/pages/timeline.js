    ...
    body.innerHTML += `
      <article class="user-post">
        <section class="post-timeline">
            ...
            <main class="group-text">
                <p class="paragraph">
                    Olá, sou aluna da Laboratoria.<br />Sou da turma SAP007.
                </p>
            </main>
            <footer class="post-footer">
                <button class="button-post">
        ...
        <section class="container-comments">
            <div class="line-post"></div>
            <textarea class="comment-input" autocomplete="on" minlength="1" maxlength="1000"
        ...
        <section class="container-comments">
            ...
            <article class="user-comment">
                ...
                <div class="group-comment">
                    ...
                    <div class="group-text-comment">
                        <p class="paragraph">
                            Comentário mais logo.<br />Com quebra de linha.
                        </p>
                    </div>
                </div>
            </article>
...
>>>>>>> origin/main:src/pages/timeline/index.js
    return container;
  },
};
